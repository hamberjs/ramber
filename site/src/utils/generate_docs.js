// TODO put this in site-kit? hamberjs.web.app uses Prism instead of hljs
import fs from 'fs';
import path from 'path';
import { SLUG_SEPARATOR, SLUG_PRESERVE_UNICODE } from '../../config';
import { extract_frontmatter, extract_metadata, langs, link_renderer } from '@hamberjs/site-kit/utils/markdown.js';
import { make_session_slug_processor } from '@hamberjs/site-kit/utils/slug';
		...
		.map(file => {
			...
			renderer.code = (source, lang) => {
				...
				if (meta) {
					...
					const filename = meta.filename || (lang === 'html' && 'App.hamber');
					if (filename) {
